...
function validateForm(values: FormValues): FieldErrors {
  ...
  if (trimmedMessage.length < 20) {
    errors.message = 'Please include at least 20 characters so we can respond well.';
  }
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="grid gap-8 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)]">
          <div>
            ...
            >
              Start the conversation with a form that feels credible and calm.
            </h2>
            <p className="mt-5 text-base leading-8 text-slate-300 sm:text-lg">
              This version keeps the form concise, adds inquiry categorization,
              uses explicit validation, and gives users clear success or error
            ...
            <div className="mt-8 space-y-3 text-sm leading-7 text-slate-300">
              <p className="rounded-2xl border border-white/10 bg-white/5 px-4 py-4">
                Use this for consultation requests, assessment questions,
                preparedness planning, or general cybersecurity and AI inquiries.
              </p>
              <p className="rounded-2xl border border-white/10 bg-white/5 px-4 py-4">
                Keep the form short enough to complete quickly, but structured
                enough that your follow-up can be specific.
              </p>
            </div>
          </div>
